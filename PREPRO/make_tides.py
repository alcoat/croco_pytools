...
#--- USER CHANGES ---------------------------------------------------------
# If you are using a tpxo dataset please be sure to have somewhere in 
# inputdata 'tpxo'. This will allow the code to use the OTIS (TPXO is obtained with it)
# convention a-b*i for complex.
# Also, if you had already preprocess TPXO, make sure that you have correct units and 
...
tides = ['M2','N2','S2','K2','K1','O1','P1','Q1']#,'L2','2N2','Mu2','La2']

# Nodal correction
Correction=False
Yorig=2005
Yini,Mini,Dini=2005,1,1
...
inpdat=Inp.getdata(inputdata,input_file_ssh,crocogrd,multi_files,input_type,tides,input_file_uv)

# --- Create the initial file -----------------------------------------

Croco.CROCO.create_tide_nc(None,''.join((croco_filename)),crocogrd,cur=cur,pot=pot)
...
# --- Start loop on waves --------------------------------------------
nc=netcdf.Dataset(croco_filename, 'a')

if Correction:
    nc.Nodal_Correction=''.join(('Origin time is ',date_orig))
else:

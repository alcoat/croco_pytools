...
input_file='list.txt' # txt file name
...
# Rivers informations
river_filename='croco_runoff.nc'
...
if Question.lower() == ("y") or Question.lower() == ("yes"):
    ...
    py.pcolormesh(crocogrd.lon,crocogrd.lat,np.ma.masked_where(crocogrd.maskr==0,crocogrd.h),vmin=0,vmax=100)

...
config_dir = '/home1/datawork/alschaef/TRAINING_2022/CONFIGS/pacifique_ird/'
config_name = 'pacifique_ird'
#
# Original ERA5 directory
#
#era5_dir_raw = config_dir + 'DATA/ERA5_native_' + config_name
era5_dir_raw = '/dataref/ref19/intranet/ERA5'
#
# Output ERA5 directory
#
#era5_dir_processed = config_dir + 'DATA/ERA5_' + config_name
era5_dir_processed = '/home1/datawork/alschaef/TRAINING_2022/DATA/ERA5_formatted/convert_dataref'
#
...
#
if 'dataref' in era_dir_raw:
    variables = [ 'sst' , 'tp'        ,'ssr'     ,'t2m'  ,'u10'  ,'v10'  ,'str'     ,'r'  ]
    conv_cff  = [  1.   ,  cff_tp     ,cff_heat  ,1.     ,1.     ,1.     ,cff_heat  ,1.   ]
    units     = [  'K'  , 'kg m-2 s-1','W m-2'   ,'K'    ,'m s-1','m s-1','W m-2'   ,'%'  ]
else:
